#!usr/bin/env python
#
# For an input [1] csv data filename [2] number of lines in data set [3] number
# of subsampled points, this program determines the exact  number of lines in
# the file by binary search, then creates a subsampled data set of the
# specified size.
#
# Number of lines can be obtained at the BASH command line with the command:
...
outFileName = subsampleExtension + numSample + '_' + dataFileName
